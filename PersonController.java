...
import com.jsp.hsp_mgmt_systm.service.PersonService;
...
public class PersonController {
	...
	public ResponseEntity<ResponseStructure<Person>> deletePerson(@RequestParam int pid){
		return personService.deletePersonById(pid);
	}
	
	@ApiOperation(value = "get person by id", notes = "api is used to fetch person")
